...
public class Generate_horoscope_birth_details extends AppCompatActivity {

    Intent intent;
    EditText Edob,Etime,Ename,Ecity,Ecountry,Elat,Elon,Etz;
    String sname="",scity="",scountry="",slat="",slon="",stz="",sdob="",stime="";
    List<String> Address_List = new ArrayList<>();
    StringBuffer sb = new StringBuffer();
    String json_url1 = Url_interface.url+"Cloud_Horoscope_Edit.php";
    String json_string="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_horoscope_birth_details);
        intialise();
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Geocoder geocoder = new Geocoder(Generate_horoscope_birth_details.this, Locale.getDefault());
                try {
                    List<Address> ads = geocoder.getFromLocationName(scity,100);
                    Log.e("ASASA",""+ads);
        ...
        findViewById(R.id.cardView2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(slat.length()>0&&slon.length()>0&&stz.length()>0) {
                    ...
                    Toast.makeText(Generate_horoscope_birth_details.this, "Enter All Details And Click the Search Button After You Entering the Place", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                if(result.equals("YES")){
                    Intent intent = new Intent(Generate_horoscope_birth_details.this,Generate_horoscope_main_menu.class);
                    ...
                    Toast.makeText(Generate_horoscope_birth_details.this, "Contact Admin", Toast.LENGTH_SHORT).show();
                }
            }catch (Exception e){
                Toast.makeText(Generate_horoscope_birth_details.this, "Contact Admin", Toast.LENGTH_SHORT).show();
            }
    ...
    public void intialise(){
        ...
        Edob.setText(intent.getStringExtra("date"));
        Etime.setText(intent.getStringExtra("time"));
        Ename.setText(intent.getStringExtra("name"));
        Ecity.setText(intent.getStringExtra("city"));
        Ecountry.setText(intent.getStringExtra("country"));
        Elat.setText(intent.getStringExtra("lat"));
        Elon.setText(intent.getStringExtra("lon"));
        Etz.setText(intent.getStringExtra("tz"));

        progressDialog = new ProgressDialog(Generate_horoscope_birth_details.this);
        progressDialog.setMessage("Please Wait...!!!");
        progressDialog.setCanceledOnTouchOutside(false);

        id = intent.getStringExtra("id");

        sessionMaintance = new SessionMaintance(Generate_horoscope_birth_details.this);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = Generate_horoscope_birth_details.this.getAssets().open("timezone.json");
    ...
    public class backgroundworker3 extends AsyncTask<Void,Void,String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                OutputStream outputStream = httpURLConnection.getOutputStream();
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                String post_data = URLEncoder.encode("city","UTF-8")+"="+URLEncoder.encode(scity.trim(),"UTF-8")+"&"
